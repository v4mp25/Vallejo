                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush small">
                            <li class="list-group-item px-0 bg-transparent py-3">
                                <span class="badge bg-danger mb-1">15 JUN</span>
                                <p class="fw-bold text-dark mb-0">Entrega de Libretas</p>
                                <small class="text-muted">Reporte del Primer Bimestre académico.</small>
                            </li>
                            <li class="list-group-item px-0 bg-transparent py-3">
                                <span class="badge bg-danger mb-1">24 JUN</span>
                                <p class="fw-bold text-dark mb-0">Día del Campesino</p>
                                <small class="text-muted">Actuación cívico-escolar especial.</small>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="card h-100 border-0 shadow-sm border-top border-warning border-4 rounded-4 p-2">
                    <div class="card-body">
                        ...
                        <hr class="text-muted">
                        <div id="lista-avisos-publicos" class="overflow-auto" style="max-height: 380px;">
                            </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card h-100 border-0 shadow-sm border-top border-primary border-4 rounded-4 p-2">
                    <div class="card-body">
                        ...
                        <div class="card border-0 bg-transparent mb-3">
                            <img src="https://via.placeholder.com/450x230" class="card-img-top rounded-3 shadow-sm mb-2" alt="Noticia">
                            <span class="text-xs text-primary fw-bold text-uppercase" style="font-size: 0.7rem; letter-spacing: 1px;">Minedu / 08 Jun</span>
                            <h6 class="fw-bold text-dark mt-1 mb-1">Implementación de Equipamiento AIP</h6>
                            <p class="text-muted small mb-2" style="font-size: 0.8rem; line-height: 1.4">Se completó la instalación de las nuevas estaciones informáticas en el Aula de Innovación...</p>
                            <a href="#" class="text-primary small fw-bold text-decoration-none">Leer noticia completa <i class="fas fa-chevron-right" style="font-size: 9px"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            if (data.avisos && data.avisos.length > 0) {
                contenedor.innerHTML = data.avisos.map(aviso => {
                    ...
                    <div class="cv-aviso-card mb-3 p-3">
                        ${imagenHtml} 
                        <h6 class="fw-bold text-dark mb-1">${aviso.titulo}</h6>
                        <p class="mb-2 small text-muted">${aviso.contenido}</p>
                        <small class="text-primary fw-bold" style="font-size: 0.75rem;"><i class="fas fa-calendar-alt me-1"></i> ${aviso.publicado_at}</small>
                    </div>
                `}).join('');
            } else {
                contenedor.innerHTML = '<p class="text-muted text-center small mt-4">No hay avisos publicados en este momento.</p>';
            }
        })
